...
def format_table6(df):
    ...
    lines.append("      Oracle uses the true standardized NIO used to plant the premium (from DGP).")
    lines.append("      Estimated values use LASSO-TE to infer NIO from observed returns.")
